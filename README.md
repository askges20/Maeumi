...
**2021 한이음 ICT 멘토링 프로젝트 [21_HF114] (2021.04 ~ 2021.11)**

- 2021 한이음 ICT 공모전 🏆**은상** 수상
- 한국정보처리학회 ACK 2021 학술발표대회 논문 게재 완료
- 한국저작권위원회 저작권 (컴퓨터프로그램) 등록 신청

<h2>개발 배경 및 필요성</h2>
<p>1. 학생들이 <b>자신의 행동에 대한 인지능력과 객관화가 미흡</b>한 것으로 나타남</p>

- 학교폭력 피해 사례가 꾸준히 증가하는 추세를 보임
- 통계 조사 결과 2019년 학교폭력 피해경험이 있는 학생은 6만명 이상으로 나타남
- 학교폭력 가해 이유의 약 30%는 "장난으로", 피해 미신고 이유는 약 30%가 "별일이 아니라 생각했기 때문"이라고 응답함

<p></p>
<p>2. <b>학교폭력 문제</b>만을 위한 <b>통합 서비스 구현</b>의 필요성</p>

- 기존 서비스 조사 결과, 학교폭력 문제만을 위한 앱이 존재하지 않음
- 서비스가 분산되어 있어 사용 복잡도가 높음<br>

👉 따라서 `학교폭력 확산 방지 및 피해자 보호를 위한 통합 서비스`를 개발하여 제공하고자 함

<h2>제공 기능</h2>
<h3>1) 학교폭력 진단테스트</h3>

- `학교폭력 피해, 가해 정도를 파악`할 수 있는 테스트
- 테스트 문항은 1388 청소년사이버상담센터 "학교 따돌림 자가 진단 검사"와 "유멘시아 관계적 공격성 심리 테스트"를 참고하여 구성함
- `광진구청소년상담복지센터`에 테스트 문항 검토를 요청하여 신뢰성을 검증받음
<div align="center">
<img src="https://user-images.githubusercontent.com/75527311/140640606-e084cdea-d303-4959-90f7-e373aec3d6ad.PNG" width="600"/>
</div>
...
- `국가법령정보센터`에서 제공되는 정보를 참고하여 상담 내용을 구성함으로써 객관적인 정보를 전할 수 있도록 함
- `Google Dialogflow 챗봇 API`를 활용하여 사용자의 채팅에 `실시간으로 응답함`
<div align="center">
  <img src="https://user-images.githubusercontent.com/75527311/140640679-58b9d529-9153-4bec-bdce-cf9a7b31a690.png" width="600"/>
</div>

<h3>3) 교화 프로그램 시청</h3>

- 교육청 학교폭력 예방 및 대책 5개년 기본 계획의 영상 프로그램에서 착안
- `YouTube API`를 활용한 학교폭력 관련 유튜브 영상 시청 기능
- 학교폭력 가해자에게 경각심을 주고 자발적인 교화가 이루어지도록 유도함
...
- 앱 이용자가 올바른 사회적 교류를 수행할 수 있도록 제공되는 `커뮤니케이션 공간`
...
- 2021 한이음 공모전 참가 - 1,2차 평가 합격, 3차 평가 발표 완료 ✔
- 한국정보처리학회 ACK 2021 학술대회 참가 - 최종본 제출 및 게재 완료 ✔
