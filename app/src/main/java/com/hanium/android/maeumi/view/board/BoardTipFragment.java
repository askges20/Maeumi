...
public class BoardTipFragment extends Fragment {

    FirebaseDatabase database;
    DatabaseReference tipBoardRef;
    PostAdapter postAdapter;

    Board board;    //Intent

    public BoardTipFragment(Board board) {
        this.board = board;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //레이아웃 연결
        View view = inflater.inflate(R.layout.board_tip_fragment, container, false);
        Context context = view.getContext();


        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.boardTipRecyclerView);
        ...
        postAdapter = new PostAdapter("tip");
